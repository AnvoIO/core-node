...
NETWORK=mainnet
NODE_ROLE=full-api
CORE_VERSION=0.1.2-alpha
CONTAINER_NAME=core-mainnet-api
BIND_IP=0.0.0.0
HTTP_PORT=9888
P2P_PORT=9876
SHIP_PORT=9080
STORAGE_PATH=/data/core-mainnet
...
0 2 * * * /opt/core-node/scripts/backup/full-backup.sh /data/core-mainnet/node.conf
```
...
*/5 * * * * /opt/core-node/scripts/monitoring/health-check.sh /data/core-mainnet/node.conf
```
