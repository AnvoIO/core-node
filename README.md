...
| `CORE_VERSION` | AnvoIO Core version | `0.1.4-alpha` |
...
GenerEOS|testnet|https://s3.us-east-1.amazonaws.com/genereos-snapshots/libre-testnet/latest.bin.zst
